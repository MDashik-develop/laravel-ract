      ...
      <div className="row justify-content-center">
        <div className='col-10'>
          <div className='row my-2'>
            ...
            <div className='col-4'>
              <Link to="/admin/brands/create" className='bg-warning text-center py-2 px-2 rounded'>Create</Link>
            </div>
          </div>
          ...
          <div className='card shadow'>
            <div className='card-body p-4'>
              ...
              {
                loader == false && brands.length == 0 && <Nostate text="Record not found" />
              }
                      ...
                      brands.map(brand => {
                        return (
                          ...
                          <tr key={brand.id}>
                            ...
                            <td>
                              <Link to={`/admin/brands/edit/${brand.id}`} className='m-1'>
                              ...
                              <Link onClick={() => deleteBrand(brand.id)} className='m-1'>
