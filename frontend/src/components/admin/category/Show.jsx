    ...
    return (
        <Layout>
            <div className="row justify-content-between align-items-center">
                <h1 className='col-3'>categories</h1>
                <Link to="/admin/categories/create" className='col-3 bg-warning text-center py-2 rounded'>Create</Link>
            </div>
                ...
                <div className='col-10'>
                    <div className='card shadow'>
                        <div className='card-body p-4'>
                            ...
                            {
                                loader == false && categories.length == 0 && <Nostate text="Record not found" />
                            }
                                            ...
                                            categories.map(category => {
                                                return (
                                                    ...
                                                    <tr key={category.id}>
                                                        ...
                                                        <td>
                                                            <Link to={`/admin/categories/edit/${category.id}`} className='m-1'>
                                                            ...
                                                            <Link onClick={() => deleteCategory(category.id)} className='m-1'>
